...
(* OASIS_START *)
(* DO NOT EDIT (digest: dbd438f4c578acde88aafaa905c7856e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["MonteCarlo_type"; "MonteCarlo"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "MonteCarlo"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "Z$\025A\023\210\188*s\167\166\t7\182t\255";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
